...
<body>
    <div id="add-product">
        <div class="form-wrap">
            <h1 class="m-heading">
                <span class="color-primary">Добавить</span> товар
            </h1>
            <?php
                if(isset($_GET['perc']))
                {
            ...
            <form action="./backend/add.php" method="POST" enctype="multipart/form-data">
                ...
                <div id="p-discount" class="form-group">
                  ...
                  <input type="number" min="0" max="100" step="0.01" name="productdiscount" value="<?php echo $product['product_discount']; ?>" placeholder="Введите скидку в %" required>
                </div>
